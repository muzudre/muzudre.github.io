    ...
    $(document).scroll(function () {
      ...
      e > r
        ? (e > 3 * r && s.addClass("headerUp"),
          ...
          c.css({
            background:
              "url(/brainhub/assets/icons/logo_" + l + ".png) no-repeat center",
        ...
        : (s.removeClass("headerUp"),
          ...
          c.css({
            background: "url(/brainhub/assets/icons/logo.png) no-repeat center",
            "background-size": "100% 100%"
          }),
          i.css("color", "#fff"),
          o.removeClass(a)),
  ...
  $(".read-next-item section").each(function () {
    ...
    (e.prototype.autoComplete = function () {
      ...
      e.length
        ...
        $.getJSON("/brainhub/search.json").done(function (a) {
          var t = "";
          for (var o in a) {
            var n = a[o],
              s = n.title,
            ...
            "" !== e &&
              ...
              (t +=
                '<a class="search_item" href="/brainhub' +
                n.url +
                '">' +
                n.title +
                "</a>");
